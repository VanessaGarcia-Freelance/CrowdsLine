...
register_nav_menu('blog', 'Blog pages menu');
...
/*-----------------------------------------------------------------------------------*/
	...
	{
	  $labels = array(
		'name' => _x('Quotes', 'post type general name', 'playne'),
		'singular_name' => _x('Quotes', 'post type singular name', 'playne'),
		'add_new' => _x('Add New', 'Quote', 'playne'),
		'add_new_item' => __('Add New Quote', 'playne'),
		'edit_item' => __('Edit Quote', 'playne'),
		'new_item' => __('New Quote', 'playne'),
		'view_item' => __('View Quote', 'playne'),
		'search_items' => __('Search Quote', 'playne'),
		'not_found' =>  __('No Quote found', 'playne'),
		'not_found_in_trash' => __('No Quote found in Trash', 'playne'),
		'parent_item_colon' => '',
		'menu_name' => 'Quotes'
	  );
	 $args = array(
	...
	function quote_updated_messages( $messages ) {
	  ...
	  $messages['quote'] = array(
		...
		1 => sprintf( __('Quote updated. <a href="%s">View project</a>'), esc_url( get_permalink($post_ID) ) ),
		2 => __('Custom field updated.', 'playne'),
		3 => __('Custom field deleted.', 'playne'),
		4 => __('Quote updated.', 'playne'),
		/* translators: %s: date and time of the revision */
		5 => isset($_GET['revision']) ? sprintf( __('Quote restored to revision from %s', 'playne'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
		6 => sprintf( __('Quote published. <a href="%s">View project</a>'), esc_url( get_permalink($post_ID) ) ),
		7 => __('Quote saved.', 'playne'),
		8 => sprintf( __('Quote submitted. <a target="_blank" href="%s">Preview project</a>'), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
		9 => sprintf( __('Quote scheduled for: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Preview project</a>'),
		  // translators: Publish box date format, see http://php.net/date
		  date_i18n( __( 'M j, Y @ G:i', 'playne'), strtotime( $post->post_date ) ), esc_url( get_permalink($post_ID) ) ),
		10 => sprintf( __('Quotes draft updated. <a target="_blank" href="%s">Preview project</a>'), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
	  );
	  return $messages;
	}
